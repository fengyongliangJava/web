package com.ifast.wechat.util.tencentface.imageclassify;


import com.ifast.wechat.util.tencentface.base.BaseClient;
import com.ifast.wechat.util.tencentface.http.TAipEBodyFormat;
import com.ifast.wechat.util.tencentface.http.TAipRequest;
import com.ifast.wechat.util.tencentface.sign.TencentAISignSort;
import com.ifast.wechat.util.tencentface.util.Base64Util;
import com.ifast.wechat.util.tencentface.util.FileUtil;
import com.ifast.wechat.util.tencentface.util.RandomNonceStrUtil;
/**
 * 计算机视觉图像识别
 * @author 小帅丶
 *
