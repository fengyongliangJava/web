...
(function (root, factory) {
	...
	renderTabs = function (config) {
		...
		var $tabOften = $('<div />', {
			class: 'pikaddress-tab pikaddress-tabOften ',
		}).append('<span class="pikaddress-tab-sapn">常用</span>');
		;
		var $tabProvince = $('<div />', {
			class: 'pikaddress-tab pikaddress-tabProvince pikaddress-tab--selected',
		}).append('<span class="pikaddress-tab-sapn">省</span>');

		var $tabCity = $('<div />', {
			class: 'pikaddress-tab-1 pikaddress-tabCity',
		...
		if(config['showCountry']){
			...
			$tabs.append($tabOften, $tabProvince, $tabCity);
		}
	...
	AAPcdPicker.prototype = {
		...
		adjustPosition: function () {
			...
			var x = $field.offset().left,
				y = $field.offset().top + $field.outerHeight();
