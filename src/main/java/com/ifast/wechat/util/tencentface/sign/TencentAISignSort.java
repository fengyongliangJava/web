package com.ifast.wechat.util.tencentface.sign;
...
import com.ifast.wechat.util.tencentface.error.ErrorTAip;
import com.ifast.wechat.util.tencentface.util.TransConstant;
/**
 * 签名生成算法方法类
 * 更新时间:2018年4月11日
